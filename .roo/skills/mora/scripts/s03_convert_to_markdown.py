...
- MORA/analysis/{document}/source-document-meta.json (optional)

Outputs:
- MORA/analysis/{document}/source-document.md
- MORA/analysis/{document}/segments.jsonl
- MORA/analysis/{document}/manifest.json (updated)
- MORA/analysis/{document}/citation.md
...
def write_manifest(document: str, title: str, source_type: str) -> None:
    ...
    manifest = {
        ...
        "ssot_path": f"MORA/analysis/{document}/{OUTPUT_MD}",
...
def write_citation(document: str, title: str, source_type: str) -> None:
    path = os.path.join(WORKSPACE_ROOT, "MORA", "analysis", document, OUTPUT_CITATION)
...
def main():
    ...
    doc_dir = os.path.join(WORKSPACE_ROOT, "MORA", "analysis", args.document)
