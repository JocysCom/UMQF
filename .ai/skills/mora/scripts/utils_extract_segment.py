...
Usage:
  python .ai/skills/mora/scripts/utils_extract_segment.py --input MORA/analysis/exploration-team/source-document.md --start 100 --output MORA/analysis/exploration-team/part1.md
  python .ai/skills/mora/scripts/utils_extract_segment.py --input big_file.txt --start 100 --end 500 --output small_part.txt
"""
